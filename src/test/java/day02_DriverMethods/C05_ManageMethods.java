...
public class C05_ManageMethods {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
         ...
         Manuel olarak bir sayfayı açtığımız methodu, timeouts().implicitlyWait() methodu ile bekleme yapmamız gerekir.
         Bir sayfaya gızda nasıl maximize yapıyorsak, otomosyon ilede yukarıdaki örnekteki gibi
         ...
         için yine manage() mittiğimizde internetten kaynaklı yada sayfaya çok fazla aynı anda giriş yapılmasından kaynaklı
