 ...
 */
    ...
    public void test01() {
        ...
        wait.until(ExpectedConditions.visibilityOf(helloWordText));
        Assert.assertEquals("Hello World!", helloWordText.getText());
    ...
    public void test02() {
        ...
        //Hello World! Yazının sitede oldugunu test et
        WebElement helloWordText= new  WebDriverWait(driver,Duration.ofSeconds(20)).
