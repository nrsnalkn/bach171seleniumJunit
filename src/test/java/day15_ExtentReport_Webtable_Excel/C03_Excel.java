...
public class C03_Excel {
     ...
     */
        ...
        //2-Dosyayı okuyabilmemiz için java da akışa almamız gerekir
        FileInputStream fis = new FileInputStream(dosyaYolu);

        //3-Java ortamında bir excel dosyası olusturmak için
        ...
        Cell cell = row.getCell(0);//index 0 dan başlar
